...
document.querySelector('.Description .modal-title').innerHTML = '<i class="far fa-comment-alt"></i>&nbsp;Mỗi lần đc chơi game với b:';
document.querySelector('.Description .modal-body').innerHTML = 'Toi lại thấy thật đặc biệt<i class="fas fa-heart"></i> ';
